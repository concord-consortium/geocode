...
import * as LavaConfig from "../assets/particles/lava.json";
    ...
    return (
      <CanvDiv ref={this.ref}>
        <Stage
          ...
          { isErupting &&
            <VolcanoEmitter
              config={LavaConfig.config as unknown as EmitterConfig}
              imagePath={LavaConfig.image}
              x={volcanoPos.x + 20}
              y={volcanoPos.y + 20} />
          }
          { isErupting &&
