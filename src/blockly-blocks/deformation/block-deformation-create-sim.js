...
javascriptGenerator.forBlock['deformation-create-graph'] = function(block) {
...
javascriptGenerator.forBlock['deformation-model-earthquake'] = function(block) {
  const code = `
    triggerEarthquake();
`;
  return code;
...
javascriptGenerator.forBlock['deformation-plot-data'] = function(block) {
