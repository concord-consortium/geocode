...
context("Controls panel", () => {
    const wsSlider='wind-speed', windSpeed = 19;
    const wdSlider="wind-direction", windDirection = 190;
    const evSlider="ejected-volume", volume = '2', evHeight='17.5';
    const chSlider="column-height", cHeight = '15', visualHeight='28.8';
